...
function makeStyles(colors: ReturnType<typeof import("@/hooks/useColors").useColors>) {
  return StyleSheet.create({
    ...
    balanceLabel: { fontSize: 14, color: "rgba(255,255,255,0.8)", fontFamily: "Inter_500Medium" },
    balanceValue: { fontSize: 42, fontWeight: "800", color: "#fff", marginVertical: 4, fontFamily: "Inter_700Bold" },
    ...
    groupInfo: { flex: 1 },
    groupName: { fontSize: 15, fontWeight: "600", color: colors.foreground, fontFamily: "Inter_600SemiBold" },
    groupMembers: { fontSize: 12, color: colors.muted, marginTop: 2 },
    groupBalance: { alignItems: "flex-end" },
    balanceAmount: { fontSize: 14, fontWeight: "700", fontFamily: "Inter_700Bold" },
